...
import { reportPothole, resetDemo } from "../services/api";
...
const HOTSPOTS = [
  ...
  { lat: 12.9698, lng: 77.75, name: "Whitefield" },
  { lat: 12.9982, lng: 77.5474, name: "Yeshwanthpur" },
  { lat: 13.0206, lng: 77.597, name: "HEBBAL" },
  { lat: 12.9822, lng: 77.637, name: "KR Puram" },
  ...
  async function toggle() {
    if (active) {
      ...
      try {
        ...
        console.error("Failed to reset database before starting demo", err);
      }
